...
*/
  ...
  const handleInputChange = (event) => {
    ...
    ); /* The length of the updated input value. */
  };
  ...
  const handleAddTag = (event) => {
    ...
    setTagCount(0);
    const newTag =
      inputValue.trim(); /* The new tag to be added to the tags state. */
              ...
              >
                <div className={classes['form-group']}>
                  <select
                    ...
                    name="eventCategory"
                    id="basic-info-eventcategory"
                  >
                    <option value="Category">Category</option>
                    <option value="Auto, Boat and Air">
                      Auto, Boat and Air
                    </option>
                    ...
                    <option value="Seasional & Holiday">
                      Seasional & Holiday
                    </option>
                ...
                >
                  <div className={classes['form-group']}>
                    <select
                      ...
                      name="subCategory"
                      id="basic-info-subcategory1"
                    >
                      <option value="Sub Category">Sub Category</option>
                      <option value="Country / Muncipal Government">
                        Country / Muncipal Government
                      </option>
                ...
                >
                  <div className={classes['form-group']}>
                    ...
                    >
                      ...
                      <option value="Drawings & Paintings">
                        Drawings & Paintings
                      </option>
                ...
                >
                  <div className={classes['form-group']}>
                    ...
                    >
                      ...
                      <option value="Mysticism and Occult">
                ...
                >
                  <div className={classes['form-group']}>
                    <select
                      ...
                      name="subCategory"
                      id="basic-info-subcategory7"
                    >
                      <option value="Sub Category">Sub Category</option>
                      <option value="After School Care">
                        After School Care
                      </option>
                ...
                >
                  <div className={classes['form-group']}>
                    ...
                    >
                      ...
                      <option value="Halloween / Haunt">
                        Halloween / Haunt
                      </option>
                      <option value="Independence Day">Independence Day</option>
                      <option value="New Years Eve">New Years Eve</option>
                      <option value="Other">Other</option>
                      <option value="Saint Patrics Day">
                        Saint Patrics Day
                      </option>
                ...
                >
                  <div className={classes['form-group']}>
                    ...
                    >
                      ...
                      <option value="Fighting & Martial Arts">
                  ...
                  <div className={classes.inputContainer}>
                    ...
                    {suggestions.length > 0 && (
                      <div className={classes.selectContainer} ref={selectRef}>
                        <select
                          id="basic-info-location-from-list"
            ...
            <React.Fragment>
              ...
              {date === 'Single Event' ? (
                <React.Fragment>
                  ...
                  >
                    <input
                      id="basic-info-display-end-time"
                      ref={displayEndRef}
                      type="checkbox"
                      name="displayEndTime"
                      style={{ marginRight: '1rem', marginTop: 0 }}
