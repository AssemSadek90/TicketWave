...
function payout() {
  return ( <div className="eds-l-mar-top-5 eds-l-pad-hor-3">
    <div className="eds-g-cell eds-g-cell-12-12 eds-g-cell-sm-8-12">
      <div className="eds-l-mar-bot-5">
        <div className="dashboard-payouts-board">
          ...
          {/* <div className="payouts-board--footer payouts-adjust-space">
            <a data-spec="eds-link" href="organizations/payouts/?event_id=591102953847" className="eds-link">
              Go to Payouts
            </a>
          </div> */}
        </div>
      ...
      <div className="eds-l-mar-top-2">
        ...
        <div className="event-url-container eds-l-mar-vert-8">
          <div className="eds-g-grid" data-testid="copy-update-label">
            ...
            {/* <div className="copy-update-label eds-g-cell eds-g-cell-8-12 eds-text-weight--heavy" id="input"> 
              https://www.eventbrite.com/e/jgjghj-tickets-591102953847
            </div> */}
