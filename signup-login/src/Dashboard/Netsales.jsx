    ...
    <div>
        ...
        <div className="dashboard-amount-card eds-l-mar-all-3 eds-l-pad-vert-3 eds-l-pad-hor-5 snipcss0-1-1-2">
          <div className="eds-text-bm card-title eds-text-weight--heavy snipcss0-2-2-3">
            <div className="display-flex snipcss0-3-3-4">
              <div
                className="eds-l-mar-right-1 snipcss0-4-4-5"
                data-testid="amount-card-title"
              >
                Net Sales
              </div>
              <span
                data-testid="amount-card-tooltip"
                className="snipcss0-4-4-6"
              >
                <div tabIndex={-1} className="snipcss0-5-6-7">
                  <div
                    className="eds-tooltip--hoc-wrapper snipcss0-6-7-8"
                    data-spec="tooltip-wrapper"
                    tabIndex={0}
                  >
                    <i
                      className="eds-vector-image eds-icon--xsmall eds-vector-image--grey-600 snipcss0-7-8-9"
                      data-spec="icon"
                      data-testid="icon"
                      aria-hidden="true"
                      title="Royalties included, if any"
                    >
                      <svg
          ...
          <div
            className="eds-l-mar-top-1 eds-text-hm snipcss0-2-2-11"
          ...
          <div className="eds-text-bs card-footer eds-l-mar-top-2 snipcss0-2-2-13"></div>
        </div>{" "}
      </div>
      <div className="cards-carousel-item eds-g-cell eds-g-cell-4-12">
        <div className="dashboard-amount-card eds-l-mar-all-3 eds-l-pad-vert-3 eds-l-pad-hor-5">
          ...
          <div className="eds-text-bs eds-l-mar-top-1">
            {Event_id.Paid} paid • {Event_id.Free} free
          </div>
          ...
          <div className="eds-l-mar-top-8">
            <div className="dashboard-task-item">
              <span className="eds-l-mar-right-3">
                <i
                  className="eds-vector-image eds-icon--xsmall eds-vector-image--ui-blue"
                  data-spec="icon"
                  data-testid="icon"
                  aria-hidden="true"
                >
                  <svg
                    className="line-chart_svg__eds-icon--line-chart__svg"
                    viewBox="0 0 24 24"
                  >
                    <path
                      className="line-chart_svg__eds-icon--line-chart__base"
                      fillRule="evenodd"
                      clipRule="evenodd"
