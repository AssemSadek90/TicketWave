...
function Orders() {
 ...
 useEffect(() => {
    ...
    server
      .get(`/orders/retrieve/1`, requestOptions)
      .then((response) => {
            ...
            <div className="eds-data-table__wrapper">
              <table className="eds-data-table__main eds-l-mar-vert-2"data-spec="data-table-main">
                ...
                <tbody className="eds-table-list">
                    {orders.map(order=>(<tr  className="eds-data-table-list-item" key={order.id}>
                    
                    <td className="eds-data-table-list-item__column">{order.id}</td> 
                    <td className="eds-data-table-list-item__column">{order.first_name}{order.last_name}</td>
                    <td className="eds-data-table-list-item__column">{order.cost}</td>
                    <td className="eds-data-table-list-item__column">{order.created}</td></tr>))}
                </tbody>)}
              </table>
            </div>
          </div>
