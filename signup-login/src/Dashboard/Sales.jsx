  ...
  return (
    ...
    <div className="eds-l-mar-top-5 eds-g-cell eds-g-cell-12-12 eds-g-cell-sm-8-12">
                ...
                <table className="eds-data-table__main eds-l-mar-vert-2" data-spec="data-table-main">
                  ...
                  <tbody className="eds-table-list">
                    <tr className="eds-data-table-list-item">
                      ...
                      <td className="eds-data-table-list-item__column" data-spec="data-table-list-item-column">
                        <a target="_blank" rel="noreferrer noopener" href="myevent/591102953847/reports/sales-by-ticket-type/?date=all&attendee_status=attending&s=1&tickets=973099579">
                          0/10
                        </a>
                      </td>
                    </tr>
      ...
      >
          ...
          <div className="eds-data-table">
            <div className="eds-data-table__wrapper">
              ...
              >
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        type="button"
                      >
                        <span className="eds-text-bm">Quantity</span>
                        <span className="eds-data-table-header__column__icon"></span>
                      </button>
                    </th>
                    <th
                ...
                <tbody className="eds-table-list"></tbody>
              </table>
            </div>
          </div>
        ...
        <div className="attendees-section__all-orders eds-l-mar-top-4 eds-l-mar-right-2">
          <a
            data-spec="eds-link"
            href="reports?eid=591102953847&rid=h&filterby=attending,all"
            className="eds-link"
          >
            Go to all Orders
          </a>
