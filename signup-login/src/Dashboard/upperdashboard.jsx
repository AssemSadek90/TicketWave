...
function upperdashboard({sold, total, cost}) {
 ...
 fetch('http://localhost:3000/Event_id')
  ...
  <div className="cards-carousel eds-g-cell eds-g-cell-12-12">
          <Netsales Nsales={Event_id.Nsales} Sold={sold} Paid={Event_id.Paid} Tickets={total} Gross={Event_id.Gross} Free={Event_id.Free} />
