...
describe.skip('Orders component', () => {
   ...
   */
  test.skip('displays "No orders for this event yet" when no orders are available', async () => {
   ...
   */
  test.skip('displays the list of orders when orders are available', async () => {
    const mockOrders = [
