...
function Upper(Event_id) {
  return (
    <section className="event-preview-card__content">
      ...
      <div  className="event-preview-card__date eds-text--truncate eds-l-mar-top-1">{Event_id.created}</div>
      <div className="event-preview-card__venue eds-text--truncate eds-l-mar-top-1">{Event_id.EventState}</div>
